...
const shieldConfig = defineConfig({
  ...
  csp: {
    ...
    directives: {
      ...
      'connect-src': ["'self'", 'https://*.libretexts.org', 'https://*.libretexts.net', 'https://*.cloudflare.com', 'https://cdn.jsdelivr.net/npm/iframe-resizer@4.4.5/js/iframeResizer.contentWindow.map', 'ws://localhost:3000'],
