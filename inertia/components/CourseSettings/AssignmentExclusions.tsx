import { GlobalState, IDWithName } from "#types/index";
...
import useCourseAssignments from "~/hooks/useCourse";
...
const AssignmentExclusions: React.FC<AssignmentExclusionsProps> = ({
  ...
  const { assignments } = useCourseAssignments(globalState.courseID);
  ...
  // useEffect(() => {
  //   updateItemsState(globalState.assignmentExclusions ?? [], assignments);
  // }, [assignments]);
