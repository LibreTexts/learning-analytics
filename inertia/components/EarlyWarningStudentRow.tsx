import { EWSResult } from '#types/index'
...
const EarlyWarningStudentRow: React.FC<EarlyWarningStudentRowProps> = ({ data }) => {
        ...
        <Card.Body className="!tw:p-0">
          <div className="tw:flex tw:flex-row tw:justify-between tw:items-center !tw:mt-4">
            <Metric
              ...
              percent={true}
              color={
                data.estimated_final < 50 ? 'dark-red' : data.estimated_final < 70 ? 'red' : 'black'
              }
            />
            <Metric
