...
import { SubmissionTimeline as ADAPTPerformanceType, VisualizationBaseProps } from '#types/index'
...
type ADAPTPerformanceProps = VisualizationBaseProps<number[]> & {
      ...
      columnHelper.group({
        ...
        header: () => (
          <div className="tw:mb-0">
            <p className="text-center tw:mb-0">Assignment: {selectedAssignmentId ?? 'Unknown'} </p>
          </div>
        ),
        columns: [
