...
import { Student, TimeInReview as TimeInReviewType, VisualizationBaseProps } from '#types/index'
...
type TimeInReviewProps = VisualizationBaseProps<TimeInReviewType[]> & {
...
const TimeInReview: React.FC<TimeInReviewProps> = ({
  ...
  function buildChart() {
    ...
    svg
      ...
      .attr('height', (d) => (height - MARGIN.bottom - y(d.value) <= 0 ? 0 : height - MARGIN.bottom - y(d.value)))
