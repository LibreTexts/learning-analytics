...
import { Student, TimeOnTask as TimeOnTaskType, VisualizationBaseProps } from '#types/index'
...
type TimeOnTaskProps = VisualizationBaseProps<TimeOnTaskType[]> & {
  selectedStudent?: Student
  selectedAssignmentId?: string
}

const TimeOnTask: React.FC<TimeOnTaskProps> = ({
  width = DEFAULT_WIDTH,
  ...
  const columnHelper = createColumnHelper<TimeOnTaskType>()
  const table = useReactTable<TimeOnTaskType>({
    data: data,
    columns: [
  ...
  function buildChart() {
    ...
    svg
      ...
      .attr('height', (d) =>
        height - MARGIN.bottom - y(d.value) <= 0 ? 0 : height - MARGIN.bottom - y(d.value)
      )
